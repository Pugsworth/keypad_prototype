 ...
 * or simply just a string of characters that are send one after another...
 *     Keystroke("//tp @p ^ ^ ^10");
 *     
 ...
 *     I am using a linked list of simplicity of streaming the objects and to avoid allocating arrays at runtime.
